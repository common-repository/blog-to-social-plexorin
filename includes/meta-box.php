...
function bts_plexorin_meta_box_callback($post) {
    ...
    <p>
        <label for="bts_plexorin_cancel_share">
            ...
            <?php esc_html_e('Do not share this post', 'bts_plexorin'); ?>
        </label>
    </p>
    <p>
        <label for="bts_plexorin_custom_title"><?php esc_html_e('Custom Title', 'bts_plexorin'); ?></label>
    ...
    <p>
        <label for="bts_plexorin_custom_description"><?php esc_html_e('Custom Description', 'bts_plexorin'); ?></label>
    ...
    <p>
        <label for="bts_plexorin_custom_image"><?php esc_html_e('Custom Featured Image', 'bts_plexorin'); ?></label>
