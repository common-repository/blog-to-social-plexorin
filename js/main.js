document.addEventListener('DOMContentLoaded', function() {
    var updatePreview = function() {
        ...
        title = title.replace('{post_title}', esc_html_e('[Post Title]', 'bts_plexorin'));
        document.querySelectorAll('.content-title').forEach(function(p) {
            p.textContent = title;
        });

        description = description.replace('{post_title}', esc_html_e('[Post Title]', 'bts_plexorin'));
        description = description.replace('{post_description}', esc_html_e('[Post Description]', 'bts_plexorin'));
        description = description.replace('{post_link}', esc_html_e('[Post Url]', 'bts_plexorin'));
        description = description.replace('{hashtags}', esc_html_e('[Hashtags]', 'bts_plexorin'));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('bts_plexorin_default_image_button').addEventListener('click', function(e) {
        ...
        frame = wp.media({
            title: esc_html_e('Select or Upload Media', 'bts_plexorin'),
            button: {
                text: esc_html_e('Use this media', 'bts_plexorin')
            },
            multiple: false
        });
